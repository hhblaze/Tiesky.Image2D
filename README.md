...
The [examples](examples/README.md) cover every ownership model. Implementation notes and extension
invariants live in `_Docs/Implementation` and must be updated with architectural or algorithmic changes.
